...
<head>
    ...
    <style>
        ...
        .date-cell.old .date-value {
            color: #dc2626;
            text-decoration: line-through;
        }

        .date-cell.new .date-value {
            color: #15803d;
        }
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <p class="intro">
                    ...
                    by the airline. Please review the new schedule details below.
                </p>
                ...
                <div class="route-banner">
                    ...
                    <div class="flight-no">Flight {{ $flightNumber }}@if($pnr) &nbsp;·&nbsp; PNR: <strong>{{ $pnr }}</strong>@endif</div>
                </div>
                ...
                <div class="date-change-grid">
                    <div class="date-cell old">
                        ...
                        <div class="date-sub">Cancelled by airline</div>
                    </div>
