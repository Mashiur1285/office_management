    ...
    <div class="px-4 py-8 md:px-6 lg:px-8 bg-[#f5f6f8] min-h-screen text-gray-800 font-sans">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <Link href="/accounting/vat-summary" class="bg-[#1e5b43] text-white px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-[#164230] transition shadow-sm border border-transparent">
                    VAT Summary
                </Link>
            </div>
        </div>
