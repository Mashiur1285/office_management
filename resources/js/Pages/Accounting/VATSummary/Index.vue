            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a :href="route('accounting.vat-summary.report')" class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors font-medium text-sm flex items-center gap-2">
            ...
            <div v-if="vatPayments && vatPayments.length > 0" class="bg-white rounded-xl shadow-sm border-4 border-purple-500 overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr v-for="payment in vatPayments" :key="payment.id" class="hover:bg-gray-50">
