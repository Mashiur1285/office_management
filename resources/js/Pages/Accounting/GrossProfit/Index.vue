        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-800 text-white shadow-xl p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-white">Gross Profit</h1>
                        <p class="text-sm text-blue-100 mt-1">Profitability Analysis - {{ period.name }}</p>
                    </div>
                    <div class="flex items-center gap-3">
                        ...
                        <a :href="route('accounting.gross-profit.report')" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-medium text-sm flex items-center gap-2">
