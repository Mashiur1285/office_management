        ...
        <div class="overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-800 text-white shadow-xl">
            <div class="px-6 py-8">
                <div class="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-[0.18em] text-blue-100">Foreign Companies</p>
                        <h1 class="text-2xl font-bold text-white">Overseas Partners</h1>
                        <p class="text-sm text-blue-100">Companies abroad receiving your candidates.</p>
                    </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <IconButton
                                        ...
                                        @click="router.visit(`/foreign-companies/${company.id}`)"
                                    />
                                    <IconButton
                                        icon="fa-solid fa-pen-to-square"
                                        class="bg-blue-600 text-white hover:bg-blue-700"
                                        tooltip="Edit company"
                                        @click="router.visit(`/foreign-companies/${company.id}/edit`)"
                                    />
                                    <IconButton
                        ...
                        <tr v-if="filteredCompanies.length === 0 && companies.length === 0">
                            <td colspan="6" class="px-6 py-8 text-center text-sm text-gray-500">
                                No companies yet. <Link href="/foreign-companies/create" class="text-blue-600 font-semibold hover:underline">Add the first one</Link>
                            </td>
                        </tr>
                        <tr v-if="filteredCompanies.length === 0 && companies.length > 0">
                            <td colspan="6" class="px-6 py-8 text-center text-sm text-gray-500">
...
const doDelete = () => {
    router.delete(`/foreign-companies/${deleteModal.value.id}`, {
        preserveScroll: true,
