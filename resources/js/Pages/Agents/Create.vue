<template>
    ...
    <div class="py-8 space-y-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.18em] text-[#1d4ed8]">Agents</p>
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        >
                            <input
                                ...
                                class="h-4 w-4 rounded border-gray-300 text-[#1d4ed8] focus:ring-[#1d4ed8]"
                            />
                            {{ service }}
                        </label>
                    </div>
...
const baseFile =
    "w-full rounded-xl border border-gray-200 px-4 py-2 text-sm text-gray-900 bg-white file:mr-3 file:rounded-md file:border-0 file:bg-gray-100 file:px-3 file:py-2 file:text-sm focus:border-[#1d4ed8] focus:ring-1 focus:ring-[#1d4ed8] outline-none transition-all";
const baseTextarea =
    "w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm transition-all focus:border-[#1d4ed8] focus:ring-1 focus:ring-[#1d4ed8] outline-none text-gray-900 bg-white";
