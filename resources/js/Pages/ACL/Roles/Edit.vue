<template>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-600">Update details and permissions.</p>
        </div>
        <Link
...
const toggleAll = () => {
    ...
    // Keep existing role/user/permission permissions that were already assigned
    const restrictedPermissionIds = form.permission_ids.filter((id) => {
    ...
    form.permission_ids = allSelected.value
        ...
        : [...restrictedPermissionIds, ...availablePermissions.map((p) => p.id)];
};
